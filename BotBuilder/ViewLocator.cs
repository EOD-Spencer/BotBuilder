...
public class ViewLocator : IDataTemplate
{
    ...
    /// </summary>
    /// <param name="param">The data context (typically a ViewModel) for which the
    /// corresponding view needs to be constructed. This can be null.</param>
    /// <returns>
    ...
    /// </summary>
    /// <param name="data">The object to examine. It is typically the data context associated
    /// with a view, and can potentially be null.</param>
    /// <returns>
